...
function App() {
  ...
  <div className="App">
    <div className="container">
      ...
      <div className="myId">
        Name : <input type="text" id="filled-basic" value={name} onChange={(e)=> setName(e.target.value)} />
        <CopyToClipboard text={me}>
          <button>Copy ID</button>
        </CopyToClipboard>
        Call to : <input type="text" value={idToCall} onChange={(e)=> setIdToCall(e.target.value)} />
